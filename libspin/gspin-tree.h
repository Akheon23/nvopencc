...
#ifdef TARG_NVISA
  GSBI_BUILT_IN_SYNCTHREADS,
  GSBI_BUILT_IN_THREADFENCE,
  GSBI_BUILT_IN_THREADFENCE_BLOCK,
#ifdef FUTURE_SUPPORT /* Fermi */
  GSBI_BUILT_IN_THREADFENCE_SYS,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_BRKPT,
  GSBI_BUILT_IN_CLOCK,
#ifdef FUTURE_SUPPORT /* Fermi */
  GSBI_BUILT_IN_CLOCK64,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_MIN,
  GSBI_BUILT_IN_UMIN,
  GSBI_BUILT_IN_LLMIN,
  GSBI_BUILT_IN_ULLMIN,
  GSBI_BUILT_IN_MAX,
  GSBI_BUILT_IN_UMAX,
  GSBI_BUILT_IN_LLMAX,
  GSBI_BUILT_IN_ULLMAX,
  GSBI_BUILT_IN_MULHI,
  GSBI_BUILT_IN_UMULHI,
  GSBI_BUILT_IN_MUL64HI,
  GSBI_BUILT_IN_UMUL64HI,
  GSBI_BUILT_IN_MUL24,
  GSBI_BUILT_IN_UMUL24,
  GSBI_BUILT_IN_INT2FLOAT,
  GSBI_BUILT_IN_FLOAT2INT,
  GSBI_BUILT_IN_LONGLONG2DOUBLE,
  GSBI_BUILT_IN_DOUBLE2LONGLONG,
  GSBI_BUILT_IN_SATURATE,
  GSBI_BUILT_IN_SATURATEF,
  GSBI_BUILT_IN_FDIV_APPROX,
#ifdef FUTURE_SUPPORT /* FERMI */
  GSBI_BUILT_IN_FMAF_ROUND,
  GSBI_BUILT_IN_FMAF_TRUNC,
  GSBI_BUILT_IN_FMAF_FLOOR,
  GSBI_BUILT_IN_FMAF_CEIL,
  GSBI_BUILT_IN_FMAF_IEEE_ROUND,
  GSBI_BUILT_IN_FMAF_IEEE_TRUNC,
  GSBI_BUILT_IN_FMAF_IEEE_FLOOR,
  GSBI_BUILT_IN_FMAF_IEEE_CEIL,
  GSBI_BUILT_IN_FDIV_ROUND,
  GSBI_BUILT_IN_FDIV_TRUNC,
  GSBI_BUILT_IN_FDIV_FLOOR,
  GSBI_BUILT_IN_FDIV_CEIL,
  GSBI_BUILT_IN_FRCP_ROUND,
  GSBI_BUILT_IN_FRCP_TRUNC,
  GSBI_BUILT_IN_FRCP_FLOOR,
  GSBI_BUILT_IN_FRCP_CEIL,
  GSBI_BUILT_IN_FSQRT_ROUND,
  GSBI_BUILT_IN_FSQRT_TRUNC,
  GSBI_BUILT_IN_FSQRT_FLOOR,
  GSBI_BUILT_IN_FSQRT_CEIL,
  GSBI_BUILT_IN_DDIV_ROUND,
  GSBI_BUILT_IN_DDIV_TRUNC,
  GSBI_BUILT_IN_DDIV_FLOOR,
  GSBI_BUILT_IN_DDIV_CEIL,
  GSBI_BUILT_IN_DRCP_ROUND,
  GSBI_BUILT_IN_DRCP_TRUNC,
  GSBI_BUILT_IN_DRCP_FLOOR,
  GSBI_BUILT_IN_DRCP_CEIL,
  GSBI_BUILT_IN_DSQRT_ROUND,
  GSBI_BUILT_IN_DSQRT_TRUNC,
  GSBI_BUILT_IN_DSQRT_FLOOR,
  GSBI_BUILT_IN_DSQRT_CEIL,
  GSBI_BUILT_IN_BREV,
  GSBI_BUILT_IN_BREVLL,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_FMA_ROUND,
  GSBI_BUILT_IN_FMA_TRUNC,
  GSBI_BUILT_IN_FMA_FLOOR,
  GSBI_BUILT_IN_FMA_CEIL,
  GSBI_BUILT_IN_F4ADD_ROUND,
  GSBI_BUILT_IN_F4ADD_TRUNC,
#ifdef FUTURE_SUPPORT /* FERMI */
  GSBI_BUILT_IN_F4ADD_FLOOR,
  GSBI_BUILT_IN_F4ADD_CEIL,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_F8ADD_ROUND,
  GSBI_BUILT_IN_F8ADD_TRUNC,
  GSBI_BUILT_IN_F8ADD_FLOOR,
  GSBI_BUILT_IN_F8ADD_CEIL,
  GSBI_BUILT_IN_F4MUL_ROUND,
  GSBI_BUILT_IN_F4MUL_TRUNC,
#ifdef FUTURE_SUPPORT /* FERMI */
  GSBI_BUILT_IN_F4MUL_FLOOR,
  GSBI_BUILT_IN_F4MUL_CEIL,
#endif /* FERMI */
  GSBI_BUILT_IN_F8MUL_ROUND,
  GSBI_BUILT_IN_F8MUL_TRUNC,
  GSBI_BUILT_IN_F8MUL_FLOOR,
  GSBI_BUILT_IN_F8MUL_CEIL,
  GSBI_BUILT_IN_SAD,
  GSBI_BUILT_IN_USAD,
  GSBI_BUILT_IN_DOUBLE_TO_FLOAT_ROUND,
  GSBI_BUILT_IN_DOUBLE_TO_FLOAT_TRUNC,
  GSBI_BUILT_IN_DOUBLE_TO_FLOAT_FLOOR,
  GSBI_BUILT_IN_DOUBLE_TO_FLOAT_CEIL,
  GSBI_BUILT_IN_DOUBLE_TO_INT_ROUND,
  GSBI_BUILT_IN_DOUBLE_TO_INT_TRUNC,
  GSBI_BUILT_IN_DOUBLE_TO_INT_FLOOR,
  GSBI_BUILT_IN_DOUBLE_TO_INT_CEIL,
  GSBI_BUILT_IN_DOUBLE_TO_UINT_ROUND,
  GSBI_BUILT_IN_DOUBLE_TO_UINT_TRUNC,
  GSBI_BUILT_IN_DOUBLE_TO_UINT_FLOOR,
  GSBI_BUILT_IN_DOUBLE_TO_UINT_CEIL,
  GSBI_BUILT_IN_INT_TO_DOUBLE_ROUND,
  GSBI_BUILT_IN_INT_TO_DOUBLE_TRUNC,
  GSBI_BUILT_IN_INT_TO_DOUBLE_FLOOR,
  GSBI_BUILT_IN_INT_TO_DOUBLE_CEIL,
  GSBI_BUILT_IN_UINT_TO_DOUBLE_ROUND,
  GSBI_BUILT_IN_UINT_TO_DOUBLE_TRUNC,
  GSBI_BUILT_IN_UINT_TO_DOUBLE_FLOOR,
  GSBI_BUILT_IN_UINT_TO_DOUBLE_CEIL,
  GSBI_BUILT_IN_INT_TO_FLOAT_ROUND,
  GSBI_BUILT_IN_INT_TO_FLOAT_TRUNC,
  GSBI_BUILT_IN_INT_TO_FLOAT_FLOOR,
  GSBI_BUILT_IN_INT_TO_FLOAT_CEIL,
  GSBI_BUILT_IN_UINT_TO_FLOAT_ROUND,
  GSBI_BUILT_IN_UINT_TO_FLOAT_TRUNC,
  GSBI_BUILT_IN_UINT_TO_FLOAT_FLOOR,
  GSBI_BUILT_IN_UINT_TO_FLOAT_CEIL,
  GSBI_BUILT_IN_FLOAT_TO_INT_ROUND,
  GSBI_BUILT_IN_FLOAT_TO_INT_TRUNC,
  GSBI_BUILT_IN_FLOAT_TO_INT_FLOOR,
  GSBI_BUILT_IN_FLOAT_TO_INT_CEIL,
  GSBI_BUILT_IN_FLOAT_TO_UINT_ROUND,
  GSBI_BUILT_IN_FLOAT_TO_UINT_TRUNC,
  GSBI_BUILT_IN_FLOAT_TO_UINT_FLOOR,
  GSBI_BUILT_IN_FLOAT_TO_UINT_CEIL,
  GSBI_BUILT_IN_HILOINT_TO_DOUBLE,
  GSBI_BUILT_IN_DOUBLE_TO_LOINT,
  GSBI_BUILT_IN_DOUBLE_TO_HIINT,
  GSBI_BUILT_IN_FLOAT_TO_LONGLONG_ROUND,
  GSBI_BUILT_IN_FLOAT_TO_LONGLONG_TRUNC,
  GSBI_BUILT_IN_FLOAT_TO_LONGLONG_FLOOR,
  GSBI_BUILT_IN_FLOAT_TO_LONGLONG_CEIL,
  GSBI_BUILT_IN_FLOAT_TO_ULONGLONG_ROUND,
  GSBI_BUILT_IN_FLOAT_TO_ULONGLONG_TRUNC,
  GSBI_BUILT_IN_FLOAT_TO_ULONGLONG_FLOOR,
  GSBI_BUILT_IN_FLOAT_TO_ULONGLONG_CEIL,
  GSBI_BUILT_IN_DOUBLE_TO_LONGLONG_ROUND,
  GSBI_BUILT_IN_DOUBLE_TO_LONGLONG_TRUNC,
  GSBI_BUILT_IN_DOUBLE_TO_LONGLONG_FLOOR,
  GSBI_BUILT_IN_DOUBLE_TO_LONGLONG_CEIL,
  GSBI_BUILT_IN_DOUBLE_TO_ULONGLONG_ROUND,
  GSBI_BUILT_IN_DOUBLE_TO_ULONGLONG_TRUNC,
  GSBI_BUILT_IN_DOUBLE_TO_ULONGLONG_FLOOR,
  GSBI_BUILT_IN_DOUBLE_TO_ULONGLONG_CEIL,
  GSBI_BUILT_IN_LONGLONG_TO_FLOAT_ROUND,
  GSBI_BUILT_IN_LONGLONG_TO_FLOAT_TRUNC,
  GSBI_BUILT_IN_LONGLONG_TO_FLOAT_FLOOR,
  GSBI_BUILT_IN_LONGLONG_TO_FLOAT_CEIL,
  GSBI_BUILT_IN_ULONGLONG_TO_FLOAT_ROUND,
  GSBI_BUILT_IN_ULONGLONG_TO_FLOAT_TRUNC,
  GSBI_BUILT_IN_ULONGLONG_TO_FLOAT_FLOOR,
  GSBI_BUILT_IN_ULONGLONG_TO_FLOAT_CEIL,
  GSBI_BUILT_IN_LONGLONG_TO_DOUBLE_ROUND,
  GSBI_BUILT_IN_LONGLONG_TO_DOUBLE_TRUNC,
  GSBI_BUILT_IN_LONGLONG_TO_DOUBLE_FLOOR,
  GSBI_BUILT_IN_LONGLONG_TO_DOUBLE_CEIL,
  GSBI_BUILT_IN_ULONGLONG_TO_DOUBLE_ROUND,
  GSBI_BUILT_IN_ULONGLONG_TO_DOUBLE_TRUNC,
  GSBI_BUILT_IN_ULONGLONG_TO_DOUBLE_FLOOR,
  GSBI_BUILT_IN_ULONGLONG_TO_DOUBLE_CEIL,
  GSBI_BUILT_IN_FLOAT_TO_HALF_ROUND,
  GSBI_BUILT_IN_HALF_TO_FLOAT,
  GSBI_BUILT_IN_IATOMICADD,
  GSBI_BUILT_IN_UATOMICADD,
  GSBI_BUILT_IN_ULLATOMICADD,
  GSBI_BUILT_IN_FATOMICADD,
  GSBI_BUILT_IN_DATOMICADD,
  GSBI_BUILT_IN_IATOMICMIN,
  GSBI_BUILT_IN_UATOMICMIN,
  GSBI_BUILT_IN_FATOMICMIN,
  GSBI_BUILT_IN_IATOMICMAX,
  GSBI_BUILT_IN_UATOMICMAX,
  GSBI_BUILT_IN_FATOMICMAX,
  GSBI_BUILT_IN_IATOMICEXCH,
  GSBI_BUILT_IN_UATOMICEXCH,
  GSBI_BUILT_IN_ULLATOMICEXCH,
  GSBI_BUILT_IN_FATOMICEXCH,
  GSBI_BUILT_IN_DATOMICEXCH,
  GSBI_BUILT_IN_IATOMICAND,
  GSBI_BUILT_IN_UATOMICAND,
  GSBI_BUILT_IN_IATOMICOR,
  GSBI_BUILT_IN_UATOMICOR,
  GSBI_BUILT_IN_IATOMICXOR,
  GSBI_BUILT_IN_UATOMICXOR,
  GSBI_BUILT_IN_UATOMICINC,
  GSBI_BUILT_IN_UATOMICDEC,
  GSBI_BUILT_IN_IATOMICCAS,
  GSBI_BUILT_IN_UATOMICCAS,
  GSBI_BUILT_IN_ULLATOMICCAS,
  GSBI_BUILT_IN_FATOMICCAS,
  GSBI_BUILT_IN_DATOMICCAS,
  GSBI_BUILT_IN_ALL,
  GSBI_BUILT_IN_ANY,
#ifdef FUTURE_SUPPORT /* FERMI */
  GSBI_BUILT_IN_BALLOT,
  GSBI_BUILT_IN_SYNCTHREADS_COUNT,
  GSBI_BUILT_IN_SYNCTHREADS_AND,
  GSBI_BUILT_IN_SYNCTHREADS_OR,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_PROF_TRIGGER,
#ifdef FUTURE_SUPPORT /* FERMI */
  GSBI_BUILT_IN_CLZ_NVISA,
  GSBI_BUILT_IN_CLZLL_NVISA,
  GSBI_BUILT_IN_POPC,
  GSBI_BUILT_IN_POPCLL,
#endif /* FUTURE_SUPPORT */
  GSBI_BUILT_IN_GETSHAREDMEM,
  GSBI_BUILT_IN_GETBLOCKIDPTR,
  GSBI_BUILT_IN_RSQRTF,
  GSBI_BUILT_IN_RSQRT,
  GSBI_BUILT_IN_PRAGMA_UNROLL,
#endif /* TARG_NVISA */
  GSBI_END_BUILTINS,

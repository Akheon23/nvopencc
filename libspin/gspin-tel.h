...
#endif
#ifdef TARG_NVISA
// add cuda attributes to c++ decl flags;
// this is a slight cheat in that they should exist for C too,
// but the main flag list is already full.
#define GS_DECL_GLOBAL				24
#define GS_DECL_SHARED				25
#define GS_DECL_LOCAL				26
#define GS_DECL_CONSTANT			27
#define GS_DECL_TEXTURE				28
#define GS_DECL_SURFACE				29
#endif /* NVISA */
...
#ifdef TARG_NVISA
// overload fields that should not be used for function_decl.
#define GS_DECL_THREAD_LIMIT 		GS_MOST_GENERAL_TEMPLATE
#define GS_DECL_BLOCK_LIMIT		GS_DECL_NAMESPACE_ALIAS
#endif /* NVISA */
...
#endif
#ifdef TARG_NVISA
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_global, GS_DECL_GLOBAL)
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_shared, GS_DECL_SHARED)
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_local, GS_DECL_LOCAL)
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_constant, GS_DECL_CONSTANT)
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_texture, GS_DECL_TEXTURE)
GS_LOOKUP_FLAG (GS_CP_DECL_FLAGS, gs_decl_surface, GS_DECL_SURFACE)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_global, GS_DECL_GLOBAL)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_shared, GS_DECL_SHARED)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_local, GS_DECL_LOCAL)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_constant, GS_DECL_CONSTANT)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_texture, GS_DECL_TEXTURE)
GS_UPDATE_FLAG (GS_CP_DECL_FLAGS, gs_set_decl_surface, GS_DECL_SURFACE)
#endif /* NVISA */
...
#ifdef TARG_NVISA
// overload fields that should not be used for function_decl.
// although we only need 16bits, is easier to just use 32
static inline gs_int_t gs_decl_thread_limit(gs_t t) {
  if (gs_operand (t, GS_DECL_THREAD_LIMIT))
    return gs_n (gs_operand (t, GS_DECL_THREAD_LIMIT));
  else return 0;
}
static inline gs_int_t gs_decl_block_limit(gs_t t) {
  if (gs_operand (t, GS_DECL_BLOCK_LIMIT))
    return gs_n (gs_operand (t, GS_DECL_BLOCK_LIMIT));
  else return 0;
}
#endif /* NVISA */

...
gs_attribute_name (gs_int_t attribute, gs_tree_code_class_t tree_code_class,
  ...
  if (tree_code_class == GS_TCC_DECLARATION) {
	...
	return (constructor == GS_TYPE_DECL) ?
      ...
      case GS_MOST_GENERAL_TEMPLATE:	
#ifdef TARG_NVISA
        if (constructor == GS_FUNCTION_DECL) return "GS_DECL_THREAD_LIMIT";
#endif
	OMIT; return "GS_MOST_GENERAL_TEMPLATE"; 
      case GS_DECL_ALIAS_TARGET:	OMIT; return "GS_DECL_ALIAS_TARGET"; 
      case GS_DECL_ASMREG:		OMIT; return "GS_DECL_ASMREG";
      case GS_DECL_NAMESPACE_ALIAS:	
#ifdef TARG_NVISA
        if (constructor == GS_FUNCTION_DECL) return "GS_DECL_BLOCK_LIMIT";
#endif
...
#ifdef TARG_NVISA
      case GS_DECL_GLOBAL:			return "GS_DECL_GLOBAL";
      case GS_DECL_SHARED:			return "GS_DECL_SHARED";
      case GS_DECL_LOCAL:			return "GS_DECL_LOCAL";
      case GS_DECL_CONSTANT:			return "GS_DECL_CONSTANT";
      case GS_DECL_TEXTURE:			return "GS_DECL_TEXTURE";
      case GS_DECL_SURFACE:			return "GS_DECL_SURFACE";
#endif /* NVISA */
      default:	GS_ASSERT(gs_false, ("gs_flag_name: missing flag name"));
    }

...
#define DECL_GLOBAL(NODE)       (DECL_COMMON_CHECK (NODE)->decl_common.is_global)
#define DECL_SHARED(NODE)       (DECL_COMMON_CHECK (NODE)->decl_common.is_shared)
#define DECL_LOCAL(NODE)        (DECL_COMMON_CHECK (NODE)->decl_common.is_local)
#define DECL_CONSTANT(NODE)     (DECL_COMMON_CHECK (NODE)->decl_common.is_constant)
#define DECL_SURFACE(NODE)      (DECL_COMMON_CHECK (NODE)->decl_common.is_surface)
#define DECL_TEXTURE(NODE)      (DECL_COMMON_CHECK (NODE)->decl_common.is_texture)
#define DECL_THREAD_LIMIT(NODE) (DECL_COMMON_CHECK (NODE)->decl_common.limit.thread_limit)
#define DECL_BLOCK_LIMIT(NODE)  (DECL_COMMON_CHECK (NODE)->decl_common.limit.block_limit)
...
/* I would like to hash ifdef this with TARG_NVISA but gengtype does not parse it */
/* #ifdef TARG_NVISA */

...
/* for NVISA/Win64 use LLP pointer model*/
#if defined(TARG_NVISA)
/* This identifies Win64 */
#ifdef _WIN64
...
#ifdef TARG_NVISA
static tree handle_global_attribute (tree *, tree, tree, int, bool *);
static tree handle_shared_attribute (tree *, tree, tree, int, bool *);
static tree handle_local_attribute (tree *, tree, tree, int, bool *);
static tree handle_constant_attribute (tree *, tree, tree, int, bool *);
static tree handle_surface_attribute (tree *, tree, tree, int, bool *);
static tree handle_texture_attribute (tree *, tree, tree, int, bool *);
static tree handle_launch_bounds_attribute (tree *, tree, tree, int, bool *);
#endif /* TARG_NVISA */
...
const struct attribute_spec c_common_attribute_table[] =
{
  ...
  { "surface",                0, 0, false, false, false,
                              handle_surface_attribute },
  { "texture",                0, 0, false, false, false,
                              handle_texture_attribute },
  { "launch_bounds",          1, 2, false, false, false,
...
static tree
handle_global_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  DECL_GLOBAL (*node) = 1;
...
static tree
handle_shared_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  DECL_SHARED (*node) = 1;
...
static tree
handle_local_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  DECL_LOCAL (*node) = 1;
...
static tree
handle_constant_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
...
static tree
handle_surface_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  DECL_SURFACE (*node) = 1;
...
static tree
handle_texture_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  DECL_TEXTURE (*node) = 1;
...
static tree
handle_launch_bounds_attribute (tree *node, tree name, tree ARG_UNUSED (args),
			   int ARG_UNUSED (flags), bool *no_add_attrs)
{
  tree next = TREE_CHAIN (args);

  DECL_THREAD_LIMIT (*node) = TREE_INT_CST_LOW (TREE_VALUE (args));
  DECL_BLOCK_LIMIT (*node)  = next ? TREE_INT_CST_LOW (TREE_VALUE (next)) : 1;

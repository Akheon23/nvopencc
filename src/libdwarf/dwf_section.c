...
_dwf_pro_generate_ehframe(Dwarf_P_Debug dbg, Dwarf_Error *error)
{
	...
	*/
	...
	if (personality) {
        ...
        // personality format
#ifdef _MSC_VER
        /* NB: Visual Studio 2005 does not support C99 mid-block variable declarations.
               This should probably be merged back to the community, since it is a more
               conservative assumption wrt the host toolchain.  */
        ...
        data += sizeof(Dwarf_Ubyte);
#ifndef _MSC_VER
        /* NB: Eventually, this should be excised in favor of above.  */
        // personality routine offset
        Dwarf_Unsigned p = 0;
#endif  /* !_MSC_VER */

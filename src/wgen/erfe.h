...
#ifdef TARG_NVISA
#define EC_Inline_Prototype	EC_BASE_FE+30	/* str */
#define EC_Inline_Ptr		EC_BASE_FE+31	/* str */
#define EC_Inline_Return_Values	EC_BASE_FE+32	/* str */
#define EC_Inline_Parameters	EC_BASE_FE+33	/* str */
#endif

...
// $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/opt/SCCS/s.opt_main.h $
//
// Revision history:
...
public:
  ...
  void	       Build_itable(ITABLE *, CFG *, CODEMAP *ivr);    // create itable
...
#ifdef TARG_NVISA
  void         Do_comic_pre(void);            // PRE based on SSA
#endif
  void         Do_expression_reshaping(void); // expression reshaping

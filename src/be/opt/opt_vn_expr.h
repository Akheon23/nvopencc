...
// $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/opt/SCCS/s.opt_vn_expr.h $
//
// ====================================================================
//
...
public:
   ...
   // across a hash-table (see opt_vn_hashtab.h). This method should never
   // be called when this->has_top_opnd() || this->has_bottom_opnd()!
   // NB: Canonicalization of VN_EXPR nodes must be performed _before_
   // any invocations of the hash function.
   //

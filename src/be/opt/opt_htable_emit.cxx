...
#ifdef TARG_NVISA
      Set_current_emitting_bb_node (bb);

      if (Target_ISA >= TARGET_ISA_compute_20 && 
          BB_is_region_ldu_preheader(bb)) {
        // Generate code to invalid uniform cache in the loop preheader
        WN *asm_wn = WN_CreateAsm_Stmt(0, "_cctlu.invall;");
...
#ifdef TARG_NVISA
      Set_current_emitting_bb_node (NULL);
#endif
    }
  }

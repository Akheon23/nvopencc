...
#endif
  ISOP_EXPR_RESHAPE_VISITED = 0x100000, // this has been visited during expression reshaping
};
...
#define Alloc_stack_cr(cnt) ((CODEREP*)alloca(sizeof(CODEREP)+(cnt)*sizeof(CODEREP *)))
  ...
  void      Print_src(INT32 indent,       // print the content in C-style for debugging
                      FILE *fp = stderr)
                      const;

  void      Print_node_src(INT32 indent,  // print the CODEREP in C-style for debugging
		       FILE *fp = stderr) const;
...
public:
  ...
  void      Print_src(FILE *fp = stderr) const;
				    // print out this STMTREP and its subtree in C-style
  void      Print_node_src(FILE *fp) const;

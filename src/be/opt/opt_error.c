 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/opt/SCCS/s.opt_error.c $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/opt/SCCS/s.opt_error.c $ $Revision: 1.5 $";

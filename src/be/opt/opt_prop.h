...
#ifdef TARG_NVISA
  BOOL     Is_allowed_preopt_case(CODEREP *src_cr, BB_NODE *src_bb, BB_NODE *dest_bb);
#endif
public:
...
#ifdef TARG_NVISA
// for controlling the propagation of restrict pointers in copy propagation
extern void Set_propagate_restrict_pointer (BOOL);
#endif // TARG_NVISA

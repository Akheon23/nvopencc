...
// $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/opt/SCCS/s.opt_vn_expr_taxonomy.h $
//
// ====================================================================
//
...
//   canonicalization (canonicalize).  Canonicalization must be invoked
//   prior to inserting a VN_EXPR in the hash table, to ensure it is done
//   only once.
//
...
//
//   Hence, canonicalization should happen before the first call to the
...
public:
   ...
   size_t hash()                        const {return (size_t)_lda_cr_id;}

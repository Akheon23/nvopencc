...
Unify_Rty(OPERATOR opr, MTYPE rty)
{
   ...
   if (MTYPE_is_integral(rty))
   {
      ...
      case OPR_REM:
#ifdef TARG_NVISA
        // signed and unsigned versions of div/rem are not equivalent
        break;
#endif
      case OPR_ADD:
      case OPR_SUB:
...
{
   // Change opcode for inequalities such that we always
   ...
   else if (opr == OPR_GT)
   {
      ...
      // Put operands in increasing order of VN if commutative.
      //

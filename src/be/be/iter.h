 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/be/SCCS/s.iter.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *be_utilrcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/be/SCCS/s.iter.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */

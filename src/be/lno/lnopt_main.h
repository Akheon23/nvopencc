...
extern struct DU_MANAGER *Du_Mgr;  // manage the def-use chains
extern struct ALIAS_MANAGER *Alias_Mgr;  // manage alias info
extern class REDUCTION_MANAGER *red_manager; // manage redution information
extern struct ARRAY_DIRECTED_GRAPH16 *Array_Dependence_Graph;  // LNO dep graph

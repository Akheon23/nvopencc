...
//Rename the two functions, so that they won't confict with the same-name
//functions in be/be/dra_clone.cxx when building static lib.
extern TY_IDX Get_Original_Type_LNO(ST* st);
extern TY_IDX Get_Array_Type_LNO(ST* st);

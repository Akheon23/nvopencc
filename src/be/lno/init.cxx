...
extern void (*Print_ACCESS_ARRAY_p) (FILE *, ACCESS_ARRAY*);
extern void (*Print_IF_INFO_p) (FILE *, IF_INFO*);
...
struct LNO_INIT
{
	...
	Perform_Loop_Nest_Optimization_p = Perform_Loop_Nest_Optimization;
        Print_ACCESS_ARRAY_p = Print_ACCESS_ARRAY;
        Print_IF_INFO_p = Print_IF_INFO;
    }
} Lno_Initializer;

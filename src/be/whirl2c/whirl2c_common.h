...
/* Initialization */
#define INIT_CONTEXT {0, 0ULL, TY_IDX_ZERO}
...
#define CONTEXT_reset_srcpos(c) (void)((c).srcpos = 0ULL)
...
#ifdef TARG_NVISA
#define CONTEXT_VOLATILE 0x00000400          /* volatile has been emmited */
#endif //TARG_NVISA
...
#ifdef TARG_NVISA
#define CONTEXT_volatile(c) ((c).flags & CONTEXT_VOLATILE)
#define CONTEXT_set_volatile(c) \
   ((c).flags = (c).flags | CONTEXT_VOLATILE)
#define CONTEXT_reset_volatile(c) \
   ((c).flags = (c).flags & ~CONTEXT_VOLATILE)
#endif //TARG_NVISA

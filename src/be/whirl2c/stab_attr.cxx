...
// Reset translated to c flag
#define MAX_ANONYMOUS_TY_ID  1000
static UINT saved_anonymous_ty[MAX_ANONYMOUS_TY_ID];
UINT num_saved_anonymous_ty;
...
static void Save_Anonymous_TY(UINT ty_idx)
{
  saved_anonymous_ty[num_saved_anonymous_ty]=ty_idx;
  num_saved_anonymous_ty++;
}

void Reset_Translated_To_c_for_Anonymous()
{
  UINT idx;

  for (idx=0; idx<num_saved_anonymous_ty; idx++)
    Reset_TY_is_translated_to_c(saved_anonymous_ty[idx]);
}

...
TCON2C_translate(TOKEN_BUFFER tokens, TCON tvalue)
{
   ...
   case MTYPE_STR:
    ...
    case MTYPE_I4:
      {
#ifdef TARG_NVISA
	if (tvalue.vals.i0 == (-2147483647 - 1))
          Append_Token_String(tokens, "(-2147483647 -1)");
        else
#endif
    ...
    case MTYPE_U4:
      {
#ifdef WIN32
	Append_Token_String(tokens, Targ_Print("0x%xU", tvalue));
#else
    ...
    case MTYPE_I8:
      ...
      if (tvalue.vals.i0 == -9223372036854775807LL -1LL) {
        Append_Token_String(tokens, "(-9223372036854775807LL -1LL)");
      }
      else 
#endif
    ...
    case MTYPE_F4:
#ifdef WIN32
      str = Targ_Print("%15.9e", tvalue);
#else //WIN32
      str = Targ_Print("%.10e", tvalue);
#endif //WIN32
      /* Exclude the inf case, we use the operation ((1.0F)/(0.0F)) to represent inf.*/
      if (*str != '(') {

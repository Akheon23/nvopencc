...
W2C_Outfile_Init(BOOL emit_global_decls)
{
   ...
   if (W2C_Verbose && W2C_Prompf_Emission )
   {
      if (W2C_File_Name[W2C_LOC_FILE] == NULL)
	 fprintf(stderr, 
   ...
   if (emit_global_decls)
   {
      ...
      Write_String(W2C_File[W2C_DOTC_FILE], W2C_File[W2C_LOC_FILE],
#ifdef TARG_NVISA
                   /* include cudafe2.gpu file rather than generated .h file */
                   /* need to drop both .cpp3 and .i first */
                   New_Extension ( 
                     Remove_Extension((char*)W2C_File_Name[W2C_ORIG_FILE]), 
                     ".cudafe2.gpu"));
#else
		   W2C_File_Name[W2C_DOTH_FILE]);
#endif
...
extern void Reset_Translated_To_c_for_Anonymous();
extern UINT num_saved_anonymous_ty;
...
W2C_Outfile_Translate_Pu(WN *pu, BOOL emit_global_decls)
{
   ...
   Reset_Translated_To_c_for_Anonymous();

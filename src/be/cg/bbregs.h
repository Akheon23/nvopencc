 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/cg/SCCS/s.bbregs.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *bbregs_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/cg/SCCS/s.bbregs.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */

 ...
 *  $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/cg/SCCS/s.gtn_universe.h $
 *
 *  Revision comments:
 *
...
extern "C" GTN_CONST INT32  GTN_UNIVERSE_size;
extern INT32  First_REGION_GTN;
extern "C" GTN_CONST INT32 *GTN_CONST GTN_UNIVERSE_tn_int_map;
extern "C" TN   *GTN_CONST *GTN_CONST GTN_UNIVERSE_int_tn_map;

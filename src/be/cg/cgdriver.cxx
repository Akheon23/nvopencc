...
static BOOL CG_rematerialize_addr_overridden= FALSE;
#endif
...
static OPTION_DESC Options_CG[] = {
  ...
  { OVK_BOOL,   OV_INTERNAL, TRUE, "rematerialize_sreg", "",
    0, 0, 0,    &CG_rematerialize_sreg, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "rematerialize_addr", "",
    0, 0, 0,    &CG_rematerialize_addr, &CG_rematerialize_addr_overridden},
  ...
  { OVK_INT32,  OV_INTERNAL, TRUE, "ftz", "",
    1, 0, 1,    &CG_use_ftz, NULL},
  { OVK_INT32,  OV_INTERNAL, TRUE, "prec_div", "",
    0, 0, 1,    &CG_use_prec_div, NULL},
  { OVK_INT32,  OV_INTERNAL, TRUE, "prec_sqrt", "",
    0, 0, 1,    &CG_use_prec_sqrt, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "dump_maxlivein", "",
    0, 0, 0,    &CG_dump_maxlivein, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "dump_fatpoint", "",
    0, 0, 0,    &CG_dump_fatpoint, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "oldstyle_params", "",
    0, 0, 0,    &CG_oldstyle_params, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "opt_register_pressure", "",
    0, 0, 0,    &CG_rp_opts, NULL},
  { OVK_BOOL,   OV_INTERNAL, TRUE, "create_unique_defs", "",
    0, 0, 0,    &CG_create_unique_tn_defs, NULL },
  { OVK_BOOL,   OV_INTERNAL, TRUE, "merge_defs", "",
    0, 0, 0,    &CG_merge_tn_defs, NULL },
#endif
  ...
  { OVK_BOOL,	OV_INTERNAL, TRUE,"put_locals_in_registers", "",
    0, 0, 0, &CGEXP_put_locals_in_registers, NULL },
#endif
 ...
 *  CORRECTION? there is no prefetch_ahead; instead use LNO_Prefetch_Ahead.
 *
 * =======================================================================
 */
static void
...
Configure_CG_Options(void)
{
 /* Set code generation options -- see	cg.h: */
  ...
  if ( Kernel_Code && ! CFLOW_Enable_Clone_overridden ) {
    ...
    if (!CG_rematerialize_addr_overridden)
      CG_rematerialize_addr = (Target_ISA >= TARGET_ISA_compute_20);
#endif

 ...
 *  $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/cg/SCCS/s.note.h $
 *
 *  Revision comments:
 *
...
#ifdef _KEEP_RCS_ID
static char *notes_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/cg/SCCS/s.note.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */

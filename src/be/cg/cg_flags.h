...
extern BOOL CGEXP_put_locals_in_registers; // put auto stack vars in registers
...
extern BOOL CG_rematerialize_sreg; // rematerialize uses of sregs
extern BOOL CG_rematerialize_addr; // rematerialize immediates into addresses
extern BOOL CG_rp_opts;           // optimize to measure/reduce register pressure
extern BOOL CG_create_unique_tn_defs; // create unique defs of TNs
extern BOOL CG_merge_tn_defs;     // merge multiple defs of same TN
...
extern INT32 CG_use_ftz;           // flush-to-zero
extern INT32 CG_use_prec_div;      // precise division and reciprocal
extern INT32 CG_use_prec_sqrt;     // precise square root

extern BOOL  CG_dump_maxlivein;    // dump max live GTN count
extern BOOL  CG_dump_fatpoint;    // dump fat point TN count
extern BOOL  CG_oldstyle_params;   // use old-style param syntax
#endif  /* TARG_NVISA */

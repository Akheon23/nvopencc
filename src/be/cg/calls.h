...
#ifdef TARG_NVISA
// return STR_IDX for a name for an indirectly called function
extern STR_IDX Get_Called_Func_Name (const WN *wn);
// return name for retval of function fname
extern char* Get_Retval_Name (const char *fname, BOOL is_formal);
// return name for "index" param of function fname
extern char* Get_Param_Name (const char *fname, INT index, BOOL is_formal);
// replace parameter register accesses with ld/st.param
extern void Modify_Parameter_Accesses (void);
#endif

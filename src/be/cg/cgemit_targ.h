...
#ifdef TARG_NVISA
// emit version and target info
extern void CGEMIT_Version_Info (char *process_name);
...
// clean up info about indirect calls at the end of a PU
extern void Finalize_Indirect_Calls_Info (void);

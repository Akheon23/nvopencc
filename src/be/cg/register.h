...
#define CREATE_CLASS_N_REG(rclass,reg)	((mUINT32)(((reg)<<8)|(rclass)))
 ...
 */
extern "C" REGISTER_CLIENT_CONST REGISTER_CLASS_INFO
 ...
 */
extern "C" REGISTER_CLIENT_CONST REGISTER_SUBCLASS_INFO

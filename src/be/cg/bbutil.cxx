...
#ifdef TARG_NVISA
  if ( print_tn_info && GRA_LIVE_Phase_Invoked)
    fprintf(TFile, "  fatpoint = %d\n", 
            Calculate_BB_Fatpoint(bp, &MEM_local_pool));
#endif // NVISA
}

/* ====================================================================
...
#ifndef TARG_NVISA // no LRA info for nvisa
...
#ifdef TARG_NVISA
    // Normal targets rely on smarts from LRA for finding minimal
    // live-range points to split the blocks; we just do the dumb thing here
    // and split when reach a certain size.
    min_idx = i;
#else

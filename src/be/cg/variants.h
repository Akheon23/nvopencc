...
#define V_TEXTURE_MEM		0x00200000
...
#define V_texture_mem(v)	((v) & V_TEXTURE_MEM)
#define Set_V_texture_mem(v)	((v) |= V_TEXTURE_MEM)
#define V_memory_space(v)	((v) & V_MEM_SPACE)
/* load uniform flag */
#define V_LD_UNIFORM            0x00400000
#define V_ld_uniform(v)         ((v) & V_LD_UNIFORM)
#define Set_V_ld_uniform(v)     ((v) |= V_LD_UNIFORM)
#define Reset_V_ld_uniform(v)     ((v) &= ~V_LD_UNIFORM)
#endif

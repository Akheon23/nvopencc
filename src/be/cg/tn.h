...
/* more_flags mask: */
#define TN_ONE_DEF          0x01	/* TN has single definition */
#define TN_FROM_SHARED_LOAD 0x02	/* TN from a ld.shared */
#define TN_FROM_PARAM_LOAD  0x04	/* TN from a ld.param */
#define TN_FROM_SREG_CVT    0x08	/* TN from a cvt sreg */
...
#define Reset_TN_is_gra_cannot_split(r) (TN_flags(r) &= ~TN_GRA_CANNOT_SPLIT)
...
#ifdef TARG_NVISA
#define     TN_more_flags(t)	(CAN_USE_TN(t)->more_flags)
#define Set_TN_more_flags(t,x)	(CAN_USE_TN(t)->more_flags = (x))
...
#define     TN_memory_space(t)		(CAN_USE_TN(t)->space)
#define Set_TN_memory_space(t,x)	(Set_TN_has_memory_space(t), CAN_USE_TN(t)->space = (x))
...
#define     TN_in_surface_mem(t)  (TN_memory_space(t) & TN_SURFACE_SPACE)
#define Set_TN_in_surface_mem(t)  (Set_TN_memory_space(t,TN_SURFACE_SPACE))

#define      TN_has_one_def(r)  (TN_more_flags(r) &   TN_ONE_DEF)
#define  Set_TN_has_one_def(r)  (TN_more_flags(r) |=  TN_ONE_DEF)
#define Reset_TN_has_one_def(r) (TN_more_flags(r) &= ~TN_ONE_DEF)
#define      TN_from_shared_load(r)  (TN_more_flags(r) &   TN_FROM_SHARED_LOAD)
#define  Set_TN_from_shared_load(r)  (TN_more_flags(r) |=  TN_FROM_SHARED_LOAD)
#define Reset_TN_from_shared_load(r) (TN_more_flags(r) &= ~TN_FROM_SHARED_LOAD)
#define      TN_from_param_load(r)  (TN_more_flags(r) &   TN_FROM_PARAM_LOAD)
#define  Set_TN_from_param_load(r)  (TN_more_flags(r) |=  TN_FROM_PARAM_LOAD)
#define Reset_TN_from_param_load(r) (TN_more_flags(r) &= ~TN_FROM_PARAM_LOAD)
#define      TN_from_sreg_cvt(r)  (TN_more_flags(r) &   TN_FROM_SREG_CVT)
#define  Set_TN_from_sreg_cvt(r)  (TN_more_flags(r) |=  TN_FROM_SREG_CVT)
#define Reset_TN_from_sreg_cvt(r) (TN_more_flags(r) &= ~TN_FROM_SREG_CVT)
#endif // NVISA

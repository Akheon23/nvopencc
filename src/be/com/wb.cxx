...
#ifndef TARG_NVISA
/* TODO: We ifdef out the call to s_lno_debug in this file for TARG_NVISA,
 * because its definition is in lno. If building static lib, we need
 * to include all *.a files to resolve the definition of this single
 * function, which is costy. Using this function is not so urgent.

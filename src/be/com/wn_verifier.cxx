...
#ifdef TARG_NVISA
            FmtAssert(!(WN_Load_Uniform(wn) && WN_class(wn) == CLASS_PREG),
              ("cannot have load_uniform on preg"));
#endif
            break;
      case OPR_LDA:
...
WN_Verifier::Field_id_valid (WN* wn)
{
	...
	break;
#ifndef TARG_NVISA // still use WN_ty cause load_addr may point to struct
    case OPR_ILOAD:

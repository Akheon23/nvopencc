 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/com/SCCS/s.DaVinci.cxx $
 *
 * Description:
  ...
  _menu_state(m)
{
  ...
  case 0:			// child
    ...
    if ( logfile ) {
      ...
      execlp ("daVinci", "daVinci", "-pipe", "-log", fname, (char*)0);
    } else {
      execlp ("daVinci", "daVinci", "-pipe", (char*)0);
    }

...
*** $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/com/SCCS/s.dvector.h $
**/

#ifndef ND_RCS_ID
#define ND_RCS_ID
#ifdef _KEEP_RCS_ID
static char *dvector_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/be/com/SCCS/s.dvector.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif

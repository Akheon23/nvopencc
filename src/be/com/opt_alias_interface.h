...
extern void PU_adjust_addr_flags(ST*, WN*, BOOL for_cg = FALSE);
extern void Recompute_addr_saved_stmt(WN *wn, BOOL for_cg = FALSE);
extern void Set_addr_saved_stmt(WN *wn, BOOL use_passed_not_saved, BOOL for_cg = FALSE);
extern void Set_addr_saved_expr(WN *wn, BOOL use_passed_not_saved, BOOL for_cg = FALSE);

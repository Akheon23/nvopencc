...
#ifndef TARG_NVISA 
/* gcc 4.1 x86_64 doesn't support mode TF
 * not sure why, but hack around it for now (we don't need long double;
 * if ever do support long double, will need to change this).
 * gcc bug 19920 has some info about related but different problem
 */
#define HAVE_TFMODE

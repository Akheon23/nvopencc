...
#define EC_Inline_Retval_Limit	EC_BASE_FE+26	/* str */
#define EC_Inline_Param_Limit	EC_BASE_FE+27	/* str */
#define EC_Inline_Texture	EC_BASE_FE+28	/* str */
#define EC_Inline_Multicore	EC_BASE_FE+29	/* str */
#endif

...
#ifdef _MSC_VER
  /* Satisfy missing member function definitions.  This probably would work for the
     other compilers also... */
BOOL DU_MANAGER::CD_is_br_taken(IDTYPE) { return FALSE; }
WN *DU_MANAGER::Get_last_stmt(IDTYPE) { return NULL; }
BOOL DU_MANAGER::Dominate(IDTYPE, IDTYPE) { return FALSE; }
BOOL DU_MANAGER::CD_is_fall_thru(IDTYPE) { return FALSE; }
IDTYPE DU_MANAGER::Get_cd(IDTYPE id) { return id; }
BB_NODE *CODEREP::Defbb(void) const { return NULL; }
BOOL CODEREP::Def_at_entry(void) const { return FALSE; }
#else  /* _MSC_VER */
extern "C" {
#if (!defined(TARG_NVISA) || defined(_LIGHTWEIGHT_INLINER))
#ifdef SHARED_BUILD

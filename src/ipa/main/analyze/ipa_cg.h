...
#ifdef TARG_NVISA
  INT32 _current_restrict_gid;  // for tracking group id for inlining
#endif
...
#ifdef TARG_NVISA
  INT32 Get_current_restrict_gid (void) { return _current_restrict_gid; }
  void Set_current_restrict_gid (INT32 gid) { _current_restrict_gid = gid; }
#endif
...
private:
  ...
  static const mUINT32 _is_inline	= 0x10;
...
public:
  ...
  void Set_Inline_Attrib ()		{ _flags |= _is_inline; }
  BOOL Has_Inline_Attrib () const	{ return _flags & _is_inline; }

  void Set_Noinline_Attrib ()		{ _flags |= _no_inline; }
  BOOL Has_Noinline_Attrib () const	{ return _flags & _no_inline; }

  void Clear_All_Inline_Attrib ()	{ _flags &= ~(_is_inline|_must_inline); }

...
struct INITV
{
    ...
    /* NB: We declare 'kind' as mUINT16 (as opposed to INITVKIND:16) so that it is always laid out
       contiguously, in a single 32-bit word, with 'repeat1'.  */
       
    mUINT16 kind;			// kind of value

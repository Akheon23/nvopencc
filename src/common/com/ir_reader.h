...
/* for dump WN tree in C-style */
extern void fdump_wn_src_no_st(FILE *fp,WN *wn);
extern void fdump_tree_src_no_st(FILE *f, WN *wn);

/* for dump WN tree to stdout in C-style */
extern void dump_tree_src(WN *);
extern void dump_tree_src_no_st(WN *);

/* for dump pragma WN */
extern void print_pragma(WN *wn, FILE *fp);

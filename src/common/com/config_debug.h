 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/SCCS/s.config_debug.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_debug_h_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/SCCS/s.config_debug.h $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
...
#endif
#ifdef TARG_NVISA
  BOOL unalign_check;		/* check for unaligned access from ptr cast */
  BOOL dump_ldu_info;           /* dump LDU analysis related statistics */
#endif
...
#endif
#ifdef TARG_NVISA
#define DEBUG_Unalign_Check		(Current_DEBUG->unalign_check)
#define DEBUG_Ldu_Analysis              (Current_DEBUG->dump_ldu_info)
#endif

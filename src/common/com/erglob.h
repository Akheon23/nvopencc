...
#ifdef TARG_NVISA
#define EC_Ipa_Recursive_Call EC_BASE_FILE+121    /* str */
#define EC_Ipa_Inline_Recursive_Call EC_BASE_FILE+122    /* str */
#endif

#define EC_Out_Of_Bound_Access_To_Structure EC_BASE_FILE+123    /* str */
#ifdef __cplusplus
}
#endif

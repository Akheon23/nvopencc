...
#ifdef Is_True_On
  ST_Verify_Class_Sclass ((ST_CLASS)sym_class, (ST_SCLASS)storage_class);
  ST_Verify_Sclass_Export ((ST_SCLASS)storage_class,  (ST_EXPORT)export_class, this);
...
void TY::Verify(UINT) const
{
    ...
    TY_Verify_Kind_Mtype ((TY_KIND)kind, mtype);
	...
	TY_Verify_Kind_Function ((TY_KIND)kind, size, mtype);

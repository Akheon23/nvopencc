...
#if defined(VENDOR_OSP) || defined(TARG_NVISA)
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "pathscale_defs.h"
    ...
    #else
#define NOINSTALL /* don't install in usual gcc place */
		  /* for use when just building comparison compiler) */
#ifdef NOINSTALL

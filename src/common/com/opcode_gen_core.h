...
/* Visual C++ always makes enums signed by default, which leads to problems here since we later stuff
   OPERATORs into an 8-bit field WN::common.wn_operator.  */
...
#ifdef FLOAT_ROUNDING_OPCODES
  OPC_F4F4RND            = OPR_RND + RTYPE(MTYPE_F4) + DESC(MTYPE_F4),
  OPC_F8F8RND            = OPR_RND + RTYPE(MTYPE_F8) + DESC(MTYPE_F8),
#endif
#ifndef TARG_X8664

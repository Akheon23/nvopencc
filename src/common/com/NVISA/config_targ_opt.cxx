...
static OPTION_DESC Options_TARG[] = {
  ...
  { OVK_SELF,	OV_SHY,		FALSE, "sm_20",	NULL,
    0, 0, 0, &ISA_Name,		NULL,
    "Use the version 2.0 instruction set architecture" },
  { OVK_SELF,	OV_SHY,		FALSE, "sm_30",	NULL,
    0, 0, 0, &ISA_Name,		NULL,
    "Use the version 3.0 instruction set architecture" },
  ...
  { OVK_SELF,	OV_SHY,		FALSE, "compute_15",	NULL,
    0, 0, 0, &ISA_Name,		NULL,
    "Use the version 1.3 instruction set architecture" },
  { OVK_SELF,	OV_SHY,		FALSE, "compute_20",	NULL,
    0, 0, 0, &ISA_Name,		NULL,
    "Use the version 2.0 instruction set architecture" },
  { OVK_SELF,	OV_SHY,		FALSE, "compute_30",	NULL,
    0, 0, 0, &ISA_Name,		NULL,
    "Use the version 3.0 instruction set architecture" },

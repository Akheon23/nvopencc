...
// these max numbers must match what is in targ_inf/abi_properties.cxx
#define MAX_NUMBER_OF_REGISTERS_FOR_RETURN 12
#define MAX_NUMBER_OF_REGISTER_PARAMETERS  32
#define MAX_NUMBER_OF_INT_REGISTER_PARAMETERS 32 
#define MAX_NUMBER_OF_FLOAT_REGISTER_PARAMETERS 32 

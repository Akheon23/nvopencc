...
/* unfortunately have to keep old syntax for old sm */
#define AS_BYTE		(Target_ISA >= TARGET_ISA_compute_20 ? ".b8" : "@@DWARF .byte")
#define AS_COM		".comm"
#define AS_DATA		".data"
#define AS_DOUBLE 	".double"
#define AS_DWORD	(Target_ISA >= TARGET_ISA_compute_20 ? ".b64" : "@@DWARF .quad")
#define AS_DWORD_UNALIGNED AS_DWORD
...
#define AS_WEAK		".weak"
#define AS_WORD		(Target_ISA >= TARGET_ISA_compute_20 ? ".b32" : "@@DWARF .4byte")
#define AS_WORD_UNALIGNED AS_WORD

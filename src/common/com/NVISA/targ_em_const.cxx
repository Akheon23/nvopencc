...
#ifndef TARG_NVISA
        /* Since NVIDIA GPUs currently do not support quad-precision (128-bit) floating-point
           types, we can safely comment out the cases below.  This may change in the future.  */
      case MTYPE_FQ: {

...
extern INT32 WOPT_Enable_Dump_WN_IR;    // control WHIRL IR dumping 
#define WOPT_Enable_Dump_WN_IR_Before_Preopt (WOPT_Enable_Dump_WN_IR & 1)
#define WOPT_Enable_Dump_WN_IR_After_Preopt (WOPT_Enable_Dump_WN_IR & 2)

extern INT32 WOPT_Enable_Dump_SSA_IR;   // control SSA-based IR dumping
#define WOPT_Enable_Dump_SSA_IR_Before_Create_SSA (WOPT_Enable_Dump_SSA_IR & 1)
#define WOPT_Enable_Dump_SSA_IR_After_Create_SSA (WOPT_Enable_Dump_SSA_IR & 2)
#define WOPT_Enable_Dump_SSA_IR_After_OPT_1 (WOPT_Enable_Dump_SSA_IR & 4)
#define WOPT_Enable_Dump_SSA_IR_After_OPT_2 (WOPT_Enable_Dump_SSA_IR & 8)
#define WOPT_Enable_Dump_SSA_IR_After_OPT_3 (WOPT_Enable_Dump_SSA_IR & 16)
#define WOPT_Enable_Dump_SSA_IR_After_OPT_4 (WOPT_Enable_Dump_SSA_IR & 32)
#define WOPT_Enable_Dump_SSA_IR_After_OPT_5 (WOPT_Enable_Dump_SSA_IR & 64)
#define WOPT_Enable_Dump_SSA_IR_After_LPRE (WOPT_Enable_Dump_SSA_IR & 128)
#define WOPT_Enable_Dump_SSA_IR_After_SPRE (WOPT_Enable_Dump_SSA_IR & 256)
#define WOPT_Enable_Dump_SSA_IR_After_BIT_DCE (WOPT_Enable_Dump_SSA_IR & 512)
#define WOPT_Enable_Dump_SSA_IR_Before_Emit (WOPT_Enable_Dump_SSA_IR & 1024)

extern BOOL WOPT_Enable_Dump_SSA_VAR_Detail;  // Enable dumping CODEREP-VAR details
...
extern INT32 WOPT_Enable_Memory_Space_Based_Alias_Analysis; // control alias analysis based on memory space
#define WOPT_Enable_Dump_Memory_Space_Based_Alias_Analysis (WOPT_Enable_Memory_Space_Based_Alias_Analysis & 2)
...
extern BOOL WOPT_Enable_LFTR2_Unsigned_Address_Compare;
...
extern INT32 WOPT_Enable_Dead_Sync_Elim;  // dead barrier sync elimination
extern INT32 WOPT_Enable_Optinfo;         // output optimization info
extern INT32 WOPT_Enable_Cons2glb;        // promote __constant__ to __global__ memory
extern BOOL WOPT_Enable_Comic_Preopt2; // pre in comic
extern INT32 WOPT_Enable_LDU_Analysis;     // control LDU analysis
extern INT32 WOPT_Enable_Convergence_Analysis; // perform convergence analysis
// control LDU generation on Const load
#define WOPT_Enable_LDU_Const_Load (WOPT_Enable_LDU_Analysis & 1)   
// control LDU generation on loads reached only from entry 
#define WOPT_Enable_LDU_Entry_Reached_Only_Load (WOPT_Enable_LDU_Analysis & 2)
// control Variance analysis using syncthreads semantics
#define WOPT_Enable_LDU_Use_Syncthreads (WOPT_Enable_LDU_Analysis & 4)
// Control region LDU Analysis
#define WOPT_Enable_Region_LDU_Analysis (WOPT_Enable_LDU_Analysis & 8)


extern BOOL WOPT_Enable_Estr_Iload;       // control strength reduction related to ILOAD iv-candidate
extern INT32 WOPT_Enable_CR_Memory_Space_Check; // control memory space check on SSA-based IR
extern BOOL WOPT_Check_Partial_Prop;
#endif
extern BOOL WOPT_Enable_Estr_Add;         // strength reduce add,sub operations
extern BOOL WOPT_Enable_Estr_Less_Adds;
extern BOOL WOPT_Enable_Expression_Reshaping; // expression reassociation
extern BOOL WOPT_Enable_Limited_Preopt_Copy_Prop; // limited cprop in pre optimizer pass

extern BOOL WOPT_Enable_STR_Short;  // whether to assume 16bit IV can cross 16

extern BOOL WOPT_Enable_PDE;
extern UINT32 WOPT_PDE_Options;
extern INT32 WOPT_PDE_Max_Iters;

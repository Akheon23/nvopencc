...
static OPTION_DESC Options_PHASE[] = {
    ...
    { OVK_NAME, OV_INTERNAL,    FALSE, "cmc", "", 0, 0, 0,
      &Run_cmc, NULL},
    { OVK_COUNT}
};
...
#ifdef TARG_NVISA
  { "CMC", ':', '=', Options_CMC, NULL,
       "Options to control cuda multi-core code generation" },
#endif
...
BOOL Run_cmc = FALSE;               /* run cuda multi-core compiliation phase */
...
Build_Skiplist ( OPTION_LIST *olist )
{
	...
	++count, ol = OLIST_next(ol) )
  {
    ...
    char *opt_name = strstr((char *)OLIST_opt(ol), "skip");
#else

 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/SCCS/s.config_debug.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_debug_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/SCCS/s.config_debug.cxx $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
...
#endif
#ifdef TARG_NVISA
    { OVK_BOOL, OV_VISIBLE,	FALSE, "unalign_check",	"",
      0, 0, 0, &ID.unalign_check,	NULL,
	"Check for potential unaligned reference from pointer casting" },

    { OVK_BOOL, OV_VISIBLE,	FALSE, "ldu",	"",
      0, 0, 0, &ID.dump_ldu_info,       NULL,
	"Dump LDU Analysis related statistics" },

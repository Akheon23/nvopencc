...
#ifdef TARG_NVISA
  // need to also track offsets for struct returns
  INT32 offset [MAX_NUMBER_OF_REGISTERS_FOR_RETURN];
#endif
public:
...
#ifdef TARG_NVISA
  friend inline INT32 RETURN_INFO_offset (const RETURN_INFO&, INT32);
#endif
...
#ifdef TARG_NVISA
inline INT32
RETURN_INFO_offset (const RETURN_INFO& info, INT32 i) { return info.offset[i]; }
#endif

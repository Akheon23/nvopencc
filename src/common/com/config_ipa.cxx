...
#ifdef TARG_NVISA
// Temporarily increse these limits.
#define DEFAULT_BLOAT_FACTOR	1000
#define DEFAULT_PU_LIMIT	20000
#define DEFAULT_HARD_LIMIT	((2500 + (2500 >> 2))*10)
#define DEFAULT_SMALL_PU	300
#define DEFAULT_SMALL_CALLEE	5000
#else
...
#ifdef TARG_NVISA
// for controlling the propagation of restrict attribute to optimizer
BOOL IPA_Enable_Inliner_prop_restrict = TRUE;
#endif
...
#ifdef TARG_NVISA
    { OVK_BOOL, OV_INTERNAL,    FALSE, "inline_prop_restrict",             "",
          0, 0, 0,              &IPA_Enable_Inliner_prop_restrict,   NULL,
          "Enable inliner to propagate restricted parameter " },
#endif
...
static OPTION_DESC Options_INLINE[] = {
...
#ifdef TARG_NVISA
    // Provide inlining tuning options in -INLINE group - begin
    // These control the same options as IPA.
    { OVK_UINT32,OV_VISIBLE,	FALSE, "hard_plimit",	"",
	  DEFAULT_HARD_LIMIT, 0, UINT32_MAX,
	  &IPA_PU_Hard_Limit, &IPA_PU_Hard_Limit_Set }, 
    { OVK_UINT32, OV_VISIBLE,	FALSE, "plimit",	"",
    ...
    { OVK_UINT32, OV_VISIBLE,	FALSE, "space",	"",
	  DEFAULT_BLOAT_FACTOR, 0, UINT32_MAX, &IPA_Bloat_Factor,
	  &IPA_Bloat_Factor_Set}, 
    // Provide inlining tuning options in -INLINE group - end
#endif
    { OVK_COUNT }	    /* List terminator -- must be last */
};

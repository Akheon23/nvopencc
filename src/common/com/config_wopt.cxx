...
INT32 WOPT_Enable_Dump_SSA_IR = 0;              // control dumping SSA IR
INT32 WOPT_Enable_Dump_WN_IR = 0;               // control dumping WHIRL IR 
BOOL  WOPT_Enable_Dump_SSA_VAR_Detail = FALSE;  // control dumping detailed variable information
#ifdef TARG_NVISA
...
INT32  WOPT_Enable_Memory_Space_Based_Alias_Analysis = 0;
#endif
...
#endif
BOOL  WOPT_Enable_LFTR2_Unsigned_Address_Compare = TRUE;
...
#if defined(TARG_X8664) || defined(TARG_NVISA) || (TARG_SL) // bug 12909
...
INT32 WOPT_Enable_Dead_Sync_Elim = 1;  // ignore dead sync elim until verified
INT32 WOPT_Enable_Optinfo = 0;  // output optimization info
INT32 WOPT_Enable_Cons2glb = 0;  // promote __constant__ to __global__ memory
BOOL WOPT_Enable_Comic_Preopt2 = FALSE;  // run second phase of pre-opt with PRE
INT32 WOPT_Enable_LDU_Analysis = 3;    // control LDU analysis, consider loads which are const qualified or reached only from entrydef 
BOOL WOPT_Enable_Estr_Iload = FALSE;     // control heuristics in Strength reduction related to
                                         // ILOAD iv-candidate
INT32 WOPT_Enable_CR_Memory_Space_Check = 1; // control memory space check on SSA-based IR
INT32 WOPT_Enable_Convergence_Analysis = 0; // Do convergence analysis
BOOL  WOPT_Check_Partial_Prop = FALSE; // default off until tuned more
#endif
BOOL WOPT_Enable_Estr_Add = TRUE;         // strength reduce add,sub operations
BOOL WOPT_Enable_Estr_Less_Adds = TRUE;         // strength reduce fewer adds
BOOL WOPT_Enable_Expression_Reshaping = TRUE; // expression reshaping
BOOL WOPT_Enable_Limited_Preopt_Copy_Prop = FALSE; // some copy-prop in preopt

BOOL WOPT_Enable_PDE = FALSE;
UINT32 WOPT_PDE_Options = 0;
INT32 WOPT_PDE_Max_Iters = 0;
...
static OPTION_DESC Options_WOPT[] = {
  ...
  { OVK_INT32,   OV_VISIBLE,     TRUE, "mem_space_alias",           "",
    0, 0, 31,    &WOPT_Enable_Memory_Space_Based_Alias_Analysis, NULL },
#endif
   {OVK_INT32,	OV_VISIBLE,	TRUE, "dump_ssa_ir",		"",
    0, 0, INT32_MAX,	&WOPT_Enable_Dump_SSA_IR, NULL },
   {OVK_INT32,	OV_VISIBLE,	TRUE, "dump_wn_ir",		"",
    0, 0, INT32_MAX,	&WOPT_Enable_Dump_WN_IR, NULL },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "dump_var_detail",           "",
    0, 0, 0,    &WOPT_Enable_Dump_SSA_VAR_Detail, NULL },
  ...
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "lftr_addr_comp",	"lftr_addr_comp",
    0, 0, 0,	&WOPT_Enable_LFTR2_Unsigned_Address_Compare, NULL },
  ...
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "aggr_iload_cse",        "",
   ...
   { OVK_INT32,   OV_VISIBLE,     TRUE, "dead_sync_elim",        "",
    0, 0, 2,    &WOPT_Enable_Dead_Sync_Elim, NULL },
  { OVK_INT32,   OV_VISIBLE,     TRUE, "optinfo",        "",
    0, 0, 2,    &WOPT_Enable_Optinfo, NULL },
  { OVK_INT32,   OV_VISIBLE,     TRUE, "const2global",        "",
    0, 0, 2,    &WOPT_Enable_Cons2glb, NULL },
   { OVK_BOOL,   OV_VISIBLE,     TRUE, "comic_pre",        "",
    0, 0, 0,    &WOPT_Enable_Comic_Preopt2, NULL },
   { OVK_INT32,   OV_VISIBLE,     TRUE, "ldu",        "ldu",
    1, 0, 511,    &WOPT_Enable_LDU_Analysis, NULL },
   { OVK_BOOL,   OV_VISIBLE,     TRUE, "estr_iload",        "",
    0, 0, 0,    &WOPT_Enable_Estr_Iload, NULL },
   { OVK_INT32,   OV_VISIBLE,     TRUE, "cr_mem",        "",
    0, 0, 7,    &WOPT_Enable_CR_Memory_Space_Check, NULL },
   { OVK_INT32,   OV_VISIBLE,     TRUE, "conv_analysis",        "",
       INT32_MAX, 0, INT32_MAX,    &WOPT_Enable_Convergence_Analysis, NULL },
   { OVK_BOOL,   OV_VISIBLE,     TRUE, "check_partial_prop",        "",
    0, 0, 0,    &WOPT_Check_Partial_Prop, NULL },
#endif
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "sr_add",                 "",
    0, 0, 0,    &WOPT_Enable_Estr_Add, NULL },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "sr_less_adds",           "",
    0, 0, 0,    &WOPT_Enable_Estr_Less_Adds, NULL },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "expr_reass",        "expr_reass",
    0, 0, 0,    &WOPT_Enable_Expression_Reshaping, NULL },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "limit_cprop",        "",
    0, 0, 0,    &WOPT_Enable_Limited_Preopt_Copy_Prop, NULL },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "wopt_pde",        "",
    0, 0, 0,    &WOPT_Enable_PDE, NULL },
   { OVK_UINT32,   OV_VISIBLE,     TRUE, "pde_options",        "",
    0, 0, UINT32_MAX,    &WOPT_PDE_Options, NULL },
   { OVK_INT32,   OV_VISIBLE,     TRUE, "pde_max_iters",        "",
    0, 0, INT32_MAX,    &WOPT_PDE_Max_Iters, NULL },

...
BOOL OPT_Enable_Struct_Init_Memset_Opt = TRUE; // convert struct init to a bunch of STIDs,
                                                // if the number of fields is small, and they
                                                // are being initialized to 0

#ifdef TARG_NVISA
BOOL OPT_Old_Mem_Ptr_Analysis = FALSE;
BOOL OPT_Enable_Reg_Reuse = FALSE;    /* A primitive attempt at stemming the PTX register glut */
BOOL OPT_Enable_Reg_Reuse_Set = FALSE;
UINT32 Opt_Unroll_Limit = 1;
BOOL OPT_Enable_Global_Ptr_Params_For_Sm2x = FALSE; /* pointer params global for sm_2x? */
#endif //TARG_NVISA
...
static OPTION_DESC Options_OPT[] = {
  ...
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "struct_init_memset_opt",        "struct_init_memset_opt",
    0, 0, 0,    &OPT_Enable_Struct_Init_Memset_Opt, NULL, NULL },
...
#ifdef TARG_NVISA
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "old_ptr_mem", "old_p",
    0, 0, 0,    &OPT_Old_Mem_Ptr_Analysis, NULL,
    "Enable the old pointer memory space analysis" },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "reuse_regs",          "",
    0, 0, 0,    &OPT_Enable_Reg_Reuse, &OPT_Enable_Reg_Reuse_Set,
    "Enable reuse of some PTX registers to reduce overall register count" },
  { OVK_UINT32,    OV_VISIBLE,	TRUE,	"unroll_limit",       "",
    0, 0, 100,    &Opt_Unroll_Limit,  NULL,
    "Check size expansion limit in user requested unrolling" },
  { OVK_BOOL,   OV_VISIBLE,     TRUE, "global_sm2x_params",          "",
    0, 0, 0,    &OPT_Enable_Global_Ptr_Params_For_Sm2x, NULL,
    "Enable pointer params to be in global space for sm_2x" },
#endif //TARG_NVISA

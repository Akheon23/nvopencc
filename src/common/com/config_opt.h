...
#endif
extern BOOL OPT_Enable_Struct_Init_Memset_Opt; // convert struct init to a bunch of STIDs,
                                               // if the number of fields is small, and they
                                               // are being initialized to 0
#ifdef TARG_NVISA
extern BOOL OPT_Old_Mem_Ptr_Analysis;/* Use old memory pointer space analysis */
extern BOOL OPT_Enable_Reg_Reuse;    /* A primitive attempt at stemming the PTX register glut */
extern BOOL OPT_Enable_Reg_Reuse_Set;
extern UINT32 Opt_Unroll_Limit; /* checking pragma unrolling code size limit */
extern BOOL OPT_Enable_Global_Ptr_Params_For_Sm2x;
#endif //TARG_NVISA

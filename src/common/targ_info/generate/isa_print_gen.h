...
#ifdef TARG_NVISA
//  void Type (void)
//	Print the instruction's type next.
//
#endif  /* TARG_NVISA */
...
//
#ifdef TARG_NVISA
//  void Set_AsmType_Func(char *(*asmtype_func)(TOP topcode))
//	Specifies a function which returns the type or types
//	associated with the given topcode. If no function is specified,
//	the assembly language type shall be the empty string ("").
//
#endif  /* TARG_NVISA */
...
#ifdef TARG_NVISA
extern void Set_AsmType_Func(const char *(*asmtype_func)(TOP topcode));
#endif  /* TARG_NVISA */
#ifdef TARG_X8664

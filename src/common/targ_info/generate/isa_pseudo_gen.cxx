...
//  $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/targ_info/generate/SCCS/s.isa_pseudo_gen.cxx $
...
#define FNAME "targ_isa_pseudo"
  ...
  fprintf(cfile, "\nTOP ISA_PSEUDO_Translate(TOP opc, INT64 *r, INT64 *o, ISA_PSEUDO_DIRECTION dir)\n"
		 ...
		 "        case 0:\n"
		 "          goto xlate_pseudo;\n",
		 /* NB: we cannot use 'max_map - 1' here as that might result in the 'arg []'
		    array having zero elements, which ANSI compilers disallow.  */
		 max_map);

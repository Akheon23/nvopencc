...
/* ===== Call/xfer is conditional ====== */
  ...
  Instruction_Group (cond,  
	TOP_bra_p, TOP_bra_np,
        TOP_bra_uni_np, // not really conditional, but need to know is not taken
			TOP_UNDEFINED);

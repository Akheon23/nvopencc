 ...
 *  $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.x_list.c $
 *
 *  Revision comments:
 *
...
static const char *rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.x_list.c $ $Revision: 1.2 $";

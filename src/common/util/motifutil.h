 ...
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.motifutil.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *motifutil_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.motifutil.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */

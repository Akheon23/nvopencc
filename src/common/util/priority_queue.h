...
*** $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.priority_queue.h $
**/
...
#ifndef PRQ_RCS_ID
#define PRQ_RCS_ID
static const char prq_rcs_id[] = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/util/SCCS/s.priority_queue.h $ $Revision: 1.2 $";
#endif
#endif

...
#if defined(VALGRIND_MAKE_MEM_NOACCESS) && !defined(VALGRIND_MAKE_NOACCESS)
#define VALGRIND_MAKE_NOACCESS(ptr, size) \
         VALGRIND_MAKE_MEM_NOACCESS(ptr, size)
#endif

#if defined(VALGRIND_MAKE_MEM_DEFINED) && !defined(VALGRIND_MAKE_READABLE)
#define VALGRIND_MAKE_READABLE(ptr, size) \
         VALGRIND_MAKE_MEM_DEFINED(ptr, size)
#endif

#if defined(VALGRIND_MAKE_MEM_UNDEFINED) && !defined(VALGRIND_MAKE_WRITABLE)

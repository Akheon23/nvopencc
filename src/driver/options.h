...
extern boolean_t option_has_blank (int flag);

/* whether the option is valid for the language */
extern boolean_t option_matches_language (int flag, languages_t l);
/* whether the option is valid for the phase */
extern boolean_t option_matches_phase (int flag, phases_t p);
/* whether the option is internal (based on language mask) */
extern boolean_t is_internal_option (int flag);
...
extern boolean_t is_derived_option (int flag);	/* is option derived? */
...
extern boolean_t no_more_options (void);
...
extern boolean_t no_more_implied_options (int flag);

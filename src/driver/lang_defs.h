...
extern boolean_t is_object_source_kind (char *src);
...
extern boolean_t ignore_suffix;	/* ignore suffix when determing source lang */

/* whether the language mask matches the specified language */
extern boolean_t is_matching_language (mask_t lang_mask, languages_t l);
/* whether the phase mask matches the specified phase */
extern boolean_t is_matching_phase (mask_t phase_mask, phases_t p);

extern boolean_t show_but_not_run;

...
extern boolean_t debug;		/* debugging turned on */

extern boolean_t nostdinc;	/* no standard include directory */

extern char *help_pattern;	/* pattern string for help file */
extern boolean_t print_help;	/* print help message */
...
extern boolean_t dashdash_flag;   /* when you see -- set this flag to
				   indicate the end of the options */

extern boolean_t read_stdin;	/* read stdin for input */

extern boolean_t  xpg_flag;
...
extern boolean_t ftz_crt;		/* add flush-to-zero crt */
...
extern boolean_t is_toggled (int obj);
...
extern boolean_t flag_is_superceded (int optflag);

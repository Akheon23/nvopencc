...
extern boolean_t option_was_seen (int optflag);
/* whether option flag was implicitly seen */
extern boolean_t option_was_implicitly_seen (int optflag);
